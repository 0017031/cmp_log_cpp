...
class ansicolor_sink : public sink
{
 public:
  ...
  virtual void set_level(level::level_enum level) override;
  virtual level::level_enum get_level() override;
...
inline void ansicolor_sink::set_level(level::level_enum level)
{
    sink_->set_level(level);
}

inline level::level_enum ansicolor_sink::get_level()
{
